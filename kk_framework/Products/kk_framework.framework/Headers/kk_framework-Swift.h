...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kk_framework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP12kk_framework10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC12kk_framework8DropDown")
...
@property (nonatomic) CGFloat offsetFromWindowBottom;
@property (nonatomic) CGFloat cellHeight;
@property (nonatomic, strong) UIColor * _Nullable backgroundColor;
/// The color of the dimmed background (behind the drop down, covering the entire screen).
@property (nonatomic, strong) UIColor * _Nonnull dimmedBackgroundColor;
...
@property (nonatomic, copy) void (^ _Nullable multiSelectionAction)(NSArray<NSNumber *> * _Nonnull, NSArray<NSString *> * _Nonnull);
...
@interface DropDown (SWIFT_EXTENSION(kk_framework))
...
@interface DropDown (SWIFT_EXTENSION(kk_framework)) <UITableViewDataSource, UITableViewDelegate>
...
- (void)selectRowsAt:(NSSet<NSNumber *> * _Nullable)indices;
- (void)deselectRowsAt:(NSSet<NSNumber *> * _Nullable)indices;
...
SWIFT_CLASS("_TtC12kk_framework12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(kk_framework))
- (void)awakeFromNib;
...
@interface UIBarButtonItem (SWIFT_EXTENSION(kk_framework)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(kk_framework)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
SWIFT_CLASS("_TtC12kk_framework11swiftSource")
@interface swiftSource : NSObject
